...
namespace wow.tools.api.Utils
{
    public static class TooltipUtils
    {
        ...
        public static bool IsStatCombatRating(int StatTypeID)
        {
        ...
        public static TTItemStat CalculateItemStat(int StatTypeID, float randProp, int ItemLevel, int statAlloc, float socketPenalty, int QualityID, int InventoryTypeID, int SubClassID, string build)
        {
            // TODO: Socket penalty
